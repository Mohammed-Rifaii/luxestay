...
<body class="about-page">
      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>About</h1>
              <p class="mb-0">Welcome to LuxeStay! We are a dedicated team of three passionate individuals 
                committed to providing a warm and welcoming stay for our guests. Our mission is to 
                offer a comfortable, relaxing, and memorable experience, whether you're visiting for leisure 
                or business. With personalized service, cozy accommodations, and a focus on hospitality,
                 we strive to make every guest feel at home. We look forward to hosting you!</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="100">
            ...
            <h3>A Passionate Team Dedicated to Exceptional Hospitality</h3>
            <p class="fst-italic"> <!-- this is a bootstrap utility that makes text italic-->
              At  LuxeStay , we are a team of three dedicated 
              members who share a passion for creating a warm and welcoming experience for every guest.
               Our mission is to provide comfortable accommodations, personalized service,
                and a relaxing atmosphere where you feel at home.
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> <span>Commitment to Excellence.</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Cozy & Comfortable Stays</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Exceptional Service & Hospitality </span></li>
            </ul>
          </div>
      ...
      <div class="container">
        ...
        <div class="row justify-content-around gy-4">
          <div class="features-image col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <img src="" id="aboutimage" alt=""></div>

          <div class="col-lg-5 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <h3>Experience Comfort and Convenience: </h3>
            <p>Why Renting a Residential Property from Us is the Best Choice for Your Next Home</p>
 ...
 ?>
  ...
  <script src="assets/js/about-images.js"></script>
