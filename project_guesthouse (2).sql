...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 12, 2025 at 06:55 AM
...
(43, 'assets/img/property-slide/serenityHouse.jpg', 3),
(44, 'assets/img/property-slide/serenityHouse2.jpg', 3),
...
(716, '2025-03-19', 27, 1011),
(717, '2025-03-20', 27, 1011);
...
INSERT INTO `website_images` (`image_id`, `image_path`, `section`) VALUES
(1, 'assets/img/aboutLogo.png', 'about');
...
--
ALTER TABLE `reservations`
  MODIFY `reservation_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=718;
