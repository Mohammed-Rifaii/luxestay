      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Agents</h1>
              <p class="mb-0">Our dedicated agents are here to assist you with bookings, special requests, and any inquiries. Whether you need travel recommendations or
      ...
      <div class="container">
        ...
        <div class="row gy-5">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="member">
              <div class="pic"><img src="assets\img\team\team_1.jpg" class="img-fluid" alt=""></div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="member">
              <div class="pic"><img src="assets/img/team/image2.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Elia AbdelMassih</h4>
